...
public class MainActivity extends AppCompatActivity {
    ...
    private void initRefresh() {
        //可以设置小圈圈的颜色，可以设置多种颜色
        refresh.setColorSchemeResources(android.R.color.holo_green_light,android.R.color.holo_red_light,android.R.color.holo_blue_light,android.R.color.holo_orange_light);
        //设置滑动多少距离有效果
        refresh.setDistanceToTriggerSync(100);

        //设置下拉刷新控件的背景
//        refresh.setProgressBackgroundColorSchemeColor(getResources().getColor(android.R.color.holo_green_light));
        ...
        refresh.setOnRefreshListener(new SwipeRefreshLayout.OnRefreshListener() {
            ...
            public void onRefresh() {
                ...
                new Handler().postDelayed(new Runnable() {
                    ...
                    public void run() {
                        addData();
                        myAdapter.notifyItemRangeChanged(0,datas.size());
